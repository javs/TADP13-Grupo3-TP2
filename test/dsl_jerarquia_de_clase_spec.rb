...
describe 'DSL para jerarquias de clase' do
  ...
  it 'debe aplicar advice si es de la jerarquia de Persona' do
    ...
    Aspecto.aplicar do
      ...
      entonces ejecutar reemplazando el original con el proc { 'soy de clase Persona' }
  ...
  it 'no debe aplicar advice si no es de la jerarquia de Linyera' do
    ...
    Aspecto.aplicar do
      ...
      entonces ejecutar reemplazando el original con el proc { 'soy de clase Linyera' }
